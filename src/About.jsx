    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          даними користувача (авторизація, сесія), що забезпечує швидку реакцію
          інтерфейсу.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Валідація завдань:</strong> автоматична перевірка правильності
          написаного коду в режимі реального часу.
        </li>
        <li>
