...
export default function EditLesson() {
  ...
  // 2. Ініціалізація CodeMirror ПІСЛЯ того, як дані завантажились і loading став false
  useEffect(() => {
    if (!loading && codeTextAreaRef.current && !editorInstance.current) {
      ...
      // Встановлюємо старий код з бази даних, якщо він є
      editorInstance.current.setValue(lessonData.code || "");

      // Слідкуємо за змінами в редакторі
  ...
  }, [loading]); // Тригеримося саме на зміну loading
    ...
    <div className="admin-container">
      ...
      <form onSubmit={handleSubmit} className="lesson-form">
        ...
        <section className="section">
          ...
          {/* Блок CodeMirror для редагування існуючого коду }
          <div
            ...
            <div key={qIndex} className="question-block">
              ...
              {q.type === "choice" ? (
                <div className="options-area">
                  ...
                  {/* Пофікшена кнопка без синтаксичних помилок /}
                  <button
                    type="button"
